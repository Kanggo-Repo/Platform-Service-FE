        ...
        <aside class="profile-card profile-summary">
            ...
            <div class="profile-meta">
                ...
                <div class="profile-meta-item">
                    ...
                    <p class="profile-meta-value">{{ $profile['updated_at_human'] ?? '-' }}</p>
                </div>
            </div>
        </aside>
        ...
        <section class="profile-card profile-form-card">
            ...
            <form action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="profile-form-grid">
                    ...
                    <div class="profile-field">
                        ...
                        <div class="profile-password-wrap">
                            <input id="profile-password" type="password" name="password" class="profile-input" autocomplete="new-password" data-password-input>
                            <button type="button" class="profile-password-toggle" data-password-toggle aria-controls="profile-password" aria-label="Lihat password baru">
                    ...
                    <div class="profile-field">
                        ...
                        <div class="profile-password-wrap">
                            <input id="profile-password-confirmation" type="password" name="password_confirmation" class="profile-input" autocomplete="new-password" data-password-input>
                            <button type="button" class="profile-password-toggle" data-password-toggle aria-controls="profile-password-confirmation" aria-label="Lihat konfirmasi password baru">
                                <i class="bi bi-eye-fill" aria-hidden="true"></i>
                            </button>
                        </div>
                    </div>
                ...
                <div class="profile-actions">
                    <a href="{{ url()->previous() === route('profile.show') ? route('workspace.index') : url()->previous() }}" class="profile-secondary-btn">Kembali</a>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('[data-password-toggle]').forEach(function (button) {
            button.addEventListener('click', function () {
                ...
                button.innerHTML = shouldShowPassword
                    ? '<i class="bi bi-eye-slash" aria-hidden="true"></i>'
                    : '<i class="bi bi-eye-fill" aria-hidden="true"></i>';
                button.setAttribute('aria-label', shouldShowPassword ? 'Sembunyikan password' : 'Lihat password');
            });
        });
    });
</script>
